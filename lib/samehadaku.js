...
class samehadaku {
  ...
  readblog({ params: { id } }, req, res, next) {
    var id = req.query.id;
	var apikey = req.query.apikey
  ...
  blogcategory({ params: { category } }, req, res, next) {
  ...
  blogCategoryByPage({ params: { category, page } }, req, res, next) {
  ...
  anime({ params: { link } }, req, res, next) {
  ...
  async readanime({ params: { link } }, req, res, next) {
    var link = req.query.link;
	var apikey = req.query.apikey
	if (!link ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter link"}) 
	if (!apikey ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter apikey"})
  ...
  search({ params: { title } }, req, res, next) {
    var title = req.query.tile;
	var apikey = req.query.apikey
  ...
  searchByPage({ params: { title, page } }, req, res, next) {
  ...
  searchByGenre({ params: { genre } }, req, res, next) {
    var genre = req.query.query;
	var apikey = req.query.apikey
